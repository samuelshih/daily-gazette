...
function colormag_entry_meta() {
   if ( 'post' == get_post_type() ) :
    ...
    <?php if (function_exists ( 'coauthors_posts_links' ) ): ?>
      <span class="byline"><span class="author vcard"><i class="fa fa-user"></i><a class="url fn n" href="<?php echo esc_url( coauthors_posts_links( get_the_author_meta( 'ID' ) ) ); ?>" title="<?php echo coauthors_posts_links(); ?>"><?php echo esc_html( coauthors_posts_links() ); ?></a></span></span>
    <?php else : ?>
