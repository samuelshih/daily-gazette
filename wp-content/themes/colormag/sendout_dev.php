...
<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td align="center">
    <table width="720px" style="font-family: georgia,?'palatino linotype',?palatino,?'times new roman',?times,?serif">
		...
		<tr>
            ...
            <img width="720px" src="<?php echo SendoutBuilder::get_static_content('email_header.png');?>"
		...
		<tr height="1px">
			<td colspan="3">
			<p style="font-size: 16px; margin: 5px; color: #555; text-align:center; background: #085E5E;">
 ...
 */?>
		...
		<tr height="1px">
			<td colspan="3">
			<p style="font-size: 20px; margin: 0; color: #555; text-align:left; background: #F5F5F5; font-weight:bold;">
                <img style="display:block;" src="<?php echo SendoutBuilder::get_static_content('slog.png') ?>" alt="THE SLOG: SWAT + BLOG" width="720px"/>
			</p>
			</td>
		</tr>
		<tr height="4px"><td colspan="3" style="background: #000; height:4px;"></td></tr>
...
<?php foreach ($comments as $comment) { ?>
    <p style="margin:2px 0 2px 4px;font-size:14px;color:#555;" >
        <a href="<?php echo get_permalink($comment->comment_post_ID)."#comment-".$comment->comment_ID;?>" style="color: #153E69; text-decoration:none">
            <b><?php echo get_the_title($comment->comment_post_ID);?></b>
        </a>
        by <i><?php echo $comment->comment_author; ?></i>
    </p>
<?php } ?>
                    </td>
				</tr></table>
		...
		<td colspan="3" style="padding:0; margin:0;">
			<table border="0" style="padding:0; margin:0;"><tr>
				<td width="340px"style="background: #F5F5F5;" align="center">
