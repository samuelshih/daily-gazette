...
function woodpecker_optionsframework_options_page() {
    ...
    ?>
	 <div class="trail-notify">
        ...
        <p style="font-size:15px; line-height: 20px;"><?php _e('You are using the WoodPecker lite version. Upgrade to pro for extra features like home page slider, video box, fullWidth page templates and many other, multiple color options, premium theme support and much more.','woodpecker');?></p>
        <a href="<?php echo esc_url('http://www.inkthemes.com/wp-themes/woodpecker-business-wordpress-theme/'); ?>" target="blank"><?php _e('Upgrade to WoodPecker PRO theme here >>','woodpecker');?></a>
     </div>
