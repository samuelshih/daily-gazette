<div class="metabox-holder" style="float:left;width:20%;">
		...
		<div class="postbox">
			<h3 class="hndle"><span>WordPress Hosting Discounts</span></h3>

			<div class="inside" style="padding: 0 12px 0;">
				<ul style="list-style: inherit;padding-left: 21px;">
				<li style="list-style-image: url(https://www.bluehost.com/favicon.ico);"><a target="_blank" href="http://peng.io/bluehost-sab" style="font-size:18px;line-height: 18px;text-decoration:none;"><strong>66%</strong> Discount at BlueHost</a></li>
				<li style="list-style-image: url(http://www.siteground.com/img/favicon.ico);"><a target="_blank" href="http://peng.io/siteground-sab" style="font-size:18px;line-height: 18px;text-decoration:none;"><strong>60%</strong> Discount at SiteGround</a></li>
				<li style="list-style-image: url(https://www.a2hosting.com/favicon.ico);"><a target="_blank" href="http://peng.io/a2-hosting-sab" style="font-size:18px;line-height: 18px;text-decoration:none;"><strong>20%</strong> Discount at A2 Hosting</a></li>
				<li style="list-style-image: url(https://wpengine.com/wp-content/themes/genesis-cog1-wpengine/images/favicon.ico);"><a target="_blank" href="http://peng.io/wp-engine-sab" style="font-size:18px;line-height: 18px;text-decoration:none;"><strong>20%</strong> Discount at WP Engine</a></li>
				</ul>
			</div>
		</div>
