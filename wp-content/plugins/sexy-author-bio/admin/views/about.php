...
<div>
<h3>Tweet About Sexy Author Bio</h3>
<div><a href="https://twitter.com/share" class="twitter-share-button" data-url="https://wordpress.org/plugins/sexy-author-bio/" data-text="I use the Sexy Author Bio WordPress Plugin" data-via="andyforsberg" data-size="large" data-hashtags="WordPress">Tweet</a>
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script></div>
<h3>Shortcode</h3>
<p>Use the following shortcode to render Sexy Author Bio wherever shortcodes are supported:</p>
...
<div>
<h3>PHP Function</h3>
<p>Use the following PHP code to render Sexy Author Bio wherever PHP is supported:</p>
...
<h3>PHP Variables</h3>
<p>Use the following PHP variables to render specific Sexy Author Bio data (currently only works when co-authors plus is not in use):</p>
<pre style="display: inline-block;background: #fff;border: 1px solid #dedee3;padding: 11px;font-size: 12px;line-height: 1.3em;overflow: auto;">
//Author Name:
echo get_the_author();
